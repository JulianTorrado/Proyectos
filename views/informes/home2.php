    ...
    <section>
        ...
        <div id="Graficas" class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">Informe de Actividades X Empresa</div>
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped table-hover">
                                <caption>Informe de Actividades</caption>
                                <thead>
                                    <tr>
                                        <th>cliente</th>
                                        <th>proyecto</th>
                                ...
                                <tbody>
                                    <?php foreach ($InformeActividad as $InformeActividades) : ?>
                                        <tr>
                                            <td><?= $InformeActividades->clientes ?></td>
                                            <td><?= $InformeActividades->proyecto_nombre ?></td>
                                            <td><?= $InformeActividades->fecha_inicio ?></td>
                                            <td><?= $InformeActividades->fecha_cierre ?></td>
                                            <td><?= $InformeActividades->total_actividades ?></td>
                                            <td><?= $InformeActividades->actividades_realizadas ?></td>
                                            <td><?= $InformeActividades->actividades_no_realizadas ?></td>
                                            <td><?= $InformeActividades->porcentaje_cumplimiento ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">Indicador de Actividades X MES</div>
                        <div class="card-body">
                            <table id="actividadesf" class="table table-bordered table-striped table-hover">
                                <caption>Indicador de Actividades X MES</caption>
                                <thead>
                                    <tr>
                                        <th>Mes</th>
                                        <th>Realizadas</th>
                                ...
                                <tbody>
                                    <?php foreach ($InformeActividadMes as $InformeActividades) : ?>
                                        <tr>
                                            <td><?= $InformeActividades->mes ?></td>
                                            <td><?= $InformeActividades->actividades_realizadas ?></td>
                                            <td><?= $InformeActividades->actividades_no_realizadas ?></td>
                                            <td><?= $InformeActividades->total_actividades ?></td>
                                            <td>90</td>
                                            <td>
                                                <?= $InformeActividades->porcentaje_cumplimiento ?>
                                                <?php
                                                if ($InformeActividades->porcentaje_cumplimiento > 90) {
                                                    echo ' ↑';
                                                } elseif ($InformeActividades->porcentaje_cumplimiento == 90) {
                                                    echo ' →';
                                                } else {
                                                    echo ' ↓';
                                                }
