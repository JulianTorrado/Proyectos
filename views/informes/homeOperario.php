...
<div class="container-fluid">
    <section>
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3">
                    <a href="?c=informes&a=TareasAsignadas">
                        <div class="info-box">
                            <span class="info-box-icon bg-danger elavation-1">
                                <i class="fas fa-check"></i>
                            </span>
                            <div class="info-box-content">
                                <div class="info-box-text">Actividades asignadas</div>
                ...
                <div class="col-md-3">
                    <a href="?c=proyectos&a=IndexOperario">
                        <div class="info-box">
                            <span class="info-box-icon bg-info elavation-1">
                                <i class="far fa-handshake"></i>
                            </span>
                            <div class="info-box-content">
                                <div class="info-box-text">Mis proyectos asignados</div>
                                <div class="info-box-number"></div>
                            </div>
                        </div>
                    </a>
